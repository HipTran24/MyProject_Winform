...
namespace MyProject.GUI
{
    public partial class ucUpdateAccount : UserControl
    {
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            ...
            string idUser = row.Cells["ColMaSV"].Value?.ToString()
                            ?? row.Cells["ColMaGV"].Value?.ToString()
                            ?? row.Cells["ColIDAdmin"].Value?.ToString();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var username = UserAccountDisplay.CurrentRow.Cells["ColUsername"].Value.ToString();
